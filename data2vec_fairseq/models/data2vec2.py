...
from data2vec_fairseq.models.modalities.base import (
    MaskSeed,
    D2vModalityConfig,
    ModalitySpecificEncoder,
    get_annealed_rate,
)
from data2vec_fairseq.models.modalities.modules import (
    D2vDecoderConfig,
    AltBlock,
    Decoder1d,
)

from data2vec_fairseq.models.modalities.audio import (
    D2vAudioConfig,
    AudioEncoder,
)
from data2vec_fairseq.models.modalities.images import (
    D2vImageConfig,
    ImageEncoder,
)
from data2vec_fairseq.models.modalities.text import (
    D2vTextConfig,
    TextEncoder,
)
